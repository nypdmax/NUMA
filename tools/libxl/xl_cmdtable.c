...
struct cmd_spec cmd_table[] = {
    ...
    { "migrate",
      &main_migrate, 0, 1,
      //"Migrate a domain to another host", [ck]
	  "Migrate a domain to another host or NUMA node (on the same host)",
      //"[options] <Domain> <host>", [ck]
	  "[options] <Domain> <host>|<node>",
      "-h              Print this help.\n"
      ...
      "                of the domain.\n"
	  "-n              [ck] Perform a NUMA migration to <node>.\n"
